...
module.exports = function(/* ctx */) {
  return {
    ...
    build: {
      ...
      env: {
        API_EXPEDIENTE: "http://localhost:3000"
      }
    },
    ...
    pwa: {
      ...
      manifest: {
        name: `Expediente Epidemiológico`,
        short_name: `Expediente Epidemiológico`,
        description: `Aplicación para la gestión de los expedientes epidemiológicos`,
        display: "standalone",
